...
$("#e").val(`<link href="//rawcdn.githack.com/hung1001/font-awesome/${sha}/css/all.css" rel="stylesheet" type="text/css" />`);
...
$("body").on("select2:select", "#list-versions", function() {
  ...
  $("#e").val(`<link href="//rawcdn.githack.com/hung1001/font-awesome/${_sha}/css/all.css" rel="stylesheet" type="text/css" />`);
});
...
$(window).on("load", function() {
  (function(d, s, id) {
    ...
    js.id = id;
    js.src = `//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v${sdk_ver}&appId=${app_id}&autoLogAppEvents=1`;
