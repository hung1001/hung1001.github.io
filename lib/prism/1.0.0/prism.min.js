...
self.addEventListener('message',function(evt){var message=JSON.parse(evt.data),lang=message.language,code=message.code;self.postMessage(JSON.stringify(_.util.encode(_.tokenize(code,_.languages[lang]))));self.close()},!1);return self.Prism}
...
return self.Prism})();if(typeof module!=='undefined'&&module.exports){module.exports=Prism}
