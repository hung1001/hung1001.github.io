...
else{code.textContent='✖ Error: File does not exist or is empty'}}};xhr.send(null)})}};document.addEventListener('DOMContentLoaded',self.Prism.fileHighlight)})()